...
contract SolarGreen is ISolarGreen, ERC20Burnable, AccessControl {
    ...
    event BlacklistChanged(address indexed addr, bool hasRole);
    ...
    function grantBlacklisterRole(address account) public onlyRole(DEFAULT_ADMIN_ROLE) {
    ...
    function revokeBlacklisterRole(address account) public onlyRole(DEFAULT_ADMIN_ROLE) {
